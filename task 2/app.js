var sno = 0;
function Save() { var a; var tableData = []; var table; sno += 1; a = document.getElementById('resultDiv'); a.style.display = "Block"; tableData = [document.createElement("td"), document.createElement("td"), document.createElement("td")]; var tableRow = document.createElement('tr'); table = document.getElementById("student"); table.appendChild(tableRow); tableRow.appendChild(tableData[0]); tableRow.appendChild(tableData[1]); tableRow.appendChild(tableData[2]); tableData[0].innerHTML = sno; if (document.getElementById('n')['value'] == '' || document.getElementById('n')['value'] == ' ') {
